...
profiles:
  - icon: at-symbol
    url: 'mailto:pavlo(dot)melnyk(at)liu(dot) se' #'mailto:pavlo.melnyk@liu.se'
  #   label: E-mail Me
  # - icon: brands/x
...
education:
  ...
  - area: 'Master of Engineering in Computer Science and Technology, 2019'
  ...
  - area: 'Bachelor in Information Security Systems, 2016'
    institution: Donetsk National Technical University (Pokrovsk, Ukraine)
    # date_start: 2012-09
    # date_end: 2016-06
    # summary: |
# work:
