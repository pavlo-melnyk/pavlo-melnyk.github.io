...
I'm a postdoctoral researcher in the division of [Computer Vision and Learning Systems](https://liu.se/en/organisation/liu/isy/cvl), [Linköping University](https://liu.se/en), Sweden, where I earned my PhD in Electrical Engineering with a specialization in Computer Vision (focusing on Geometric Deep Learning), supervised by [Michael Felsberg](https://liu.se/en/employee/micfe03) and funded by [WASP](https://wasp-sweden.org/). You can find more details in my <a href="/uploads/cv.pdf" target="_blank" class="btn btn-primary">CV</a>.